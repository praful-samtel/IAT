...
BEGIN_MESSAGE_MAP(CWndSliderView, CView)
	...
	//}}AFX_MSG_MAP
	ON_MESSAGE(WM_CUSTOM_CLICK,SimulateBtnClick)
END_MESSAGE_MAP()
...
{	
//	ButtonWizard SliderWindow;	
	CView::OnLButtonDown(nFlags, point);	
 	char ch = 1;
	int nButton1 = ButtonHitTest( point );
    
    if(nButton1 == 4 || nButton1 == 0|| nButton1 == 2 )
//    GRP.MainThreadActiveFlag = 0;

	//	if(GRP.MainThreadActiveFlag  != 0 )
	//	{
	//		printlog("\n Slider window locked");
	//		return;
	//	}
	...
	//{
		...
		int nButton = ButtonHitTest( point );
//		SliderWindow.CurrentButton = nButton;
...
{	
	...
	int nButton1 = ButtonHitTest( point );
#if 0
	if(GRP.SIPUConnected ==1 && GRP.SDUConnected == 1)
	{
       if(nButton1 == 0)
		   ch = 1;
		else
	...
	if(ch == 0)
	{
       printlog("\n SIPU && SDU is Not Connected");
	}


 /* Check SIPU Connected */
	if(GRP.SIPUConnected == 1)
	{
       if(nButton1 == 0 || nButton1 == 1 || nButton1 == 3 || nButton1 == 6 || nButton1 == 8)
		   ch = 1;
		else
		   ch = 0;    
	...
	if(ch == 0)
	{
       printlog("\n SIPU is not Connected");
	}

/* Check SDU Connected */
	if(GRP.SDUConnected == 1)
	{
       if(nButton1 == 0 || nButton1 == 1 || nButton1 == 2 || nButton1 == 5 )
		   ch = 1;
		else
		   ch = 0;    
	}
	...
	if(GRP.SDUNormalMode == 1)
	{
       if(nButton1 == 0 || nButton1 == 1 || nButton1 == 2 || nButton1 == 3 || nButton1 == 4 || nButton1 == 6 || nButton1 == 8 || nButton1 == 9 || nButton1 == 10)
		 ch = 1;
		else
		 ch = 0;    
	}
	...
	if(ch == 0)
	{
       printlog("\n SDU is Configured in Normal Mode ");
	   return;
	}

 /* SDU SImulation Mode */
	if(GRP.SDUSimulatMode == 1)
	{
       if(nButton1 == 0 || nButton1 == 1 || nButton1 == 2 || nButton1 == 3 || nButton1 == 4 || nButton1 == 6 || nButton1 == 8 || nButton1 == 9 || nButton1 == 10)
		   ch = 1;
		else
	...
	if(ch == 0)
	{
       printlog("\n SDU is Configured in Simulation Mode ");
	   return;
	}


	if(GRP.SDUMaintMode == 1)
	{
       if(nButton1 == 0 || nButton1 == 1 || nButton1 == 2 || nButton1 == 3 || nButton1 == 4 || nButton1 == 6 || nButton1 == 8)
		   ch = 1;
		else
		 ch = 0;    
	}
	...
	if(ch == 0)
	{
       printlog("\n SDU is Configured in Maintanance Mode ");
	   return;
	}
#endif 
...
LRESULT CWndSliderView::SimulateBtnClick(WPARAM wParam, LPARAM lParam)
{

 	if(m_nActiveView == wParam) return 0;
	if(wParam >= GetViewCount()) wParam = 0;
	ViewAnimation( wParam, m_nActiveView );				
	m_nActiveView = wParam;
	RecalcLayout();
	Invalidate(); 
	return 0;
}
