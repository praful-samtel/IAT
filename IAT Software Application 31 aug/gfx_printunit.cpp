...
*                           void GPrintUnit::InsertPrintCol                           *
*                           (int nPos, LPCTSTR lpszName, double fColPct, int nHeading)*
*							void GPrintUnit::InsertPrintCol                           *            
*                                int nPos, UINT nIDName, double fColPct, int nHeading)* 
*							void GPrintUnit::InsertPrintCo                            *
*                                (LPPRINTCOLUMN pCol, int nHeading)                   *
...
*							void GPrintUnit::PrintColHeading(int nCol,                *
*                    LPCTSTR lpszName, int nLen, CRect r,UINT nFormat, UINT nEffects) *
*                           void GPrintUnit::DoHeadingEffect(int nCol,                *
*                    LPCTSTR lpszName, int nLen, CRect r, UINT nFormat, UINT nEffects)*
