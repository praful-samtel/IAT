...
// -------- ANALOG2 --------
ADD_TEST(412,412,4,"SMFD FC Analog2","Hydraulic Main Pressure",&dlgSmfdAnalog2,"2930±20 psi");
ADD_TEST(413,413,4,"SMFD FC Analog2","Hydraulic Emergency Pressure",&dlgSmfdANHPE,"3330±20 psi");
ADD_TEST(414,414,4,"SMFD FC Analog2","Emergency Brake Pressure",&dlgSmfdANEB,"1300±15 psi");
ADD_TEST(415,415,4,"SMFD FC Analog2","LH Brake Pressure",&dlgSmfdANLBP,"1200±15 psi");
ADD_TEST(416,416,4,"SMFD FC Analog2","RH Brake Pressure",&dlgSmfdANRBP,"1200±15 psi");
ADD_TEST(417,417,4,"SMFD FC Analog2","Engine Speed",&dlgSmfdANES,"79±2 rpm");
ADD_TEST(418,418,4,"SMFD FC Analog2","Fuel LH",&dlgSmfdANFTL,"168±5 lb");
ADD_TEST(419,419,4,"SMFD FC Analog2","Fuel RH",&dlgSmfdANFTR,"168±5 lb");
ADD_TEST(420,420,4,"SMFD FC Analog2","Collector Tank Fuel",&dlgSmfdANCT,"183±5 lb");
...
// -------- ANALOG --------
ADD_TEST(401,401,4,"SMFD RC Analog","Oil Temp",&dlgSmfdAnalog,"60±2 °C");
ADD_TEST(402,402,4,"SMFD RC Analog","Oil Pressure",&dlgSmfdAnalog,"40±3 psi");
ADD_TEST(403,403,4,"SMFD RC Analog","Torque",&dlgSmfdAnalog,"1740±4 ft-lb");
ADD_TEST(404,404,4,"SMFD RC Analog","Rudder",&dlgSmfdAnalog,"Nose at centre white line");
ADD_TEST(405,405,4,"SMFD RC Analog","Elevator",&dlgSmfdAnalog,"Nose at green line & -1.2 deg");
ADD_TEST(406,406,4,"SMFD RC Analog","Aileron",&dlgSmfdAnalog,"Wing at green line");
ADD_TEST(407,407,4,"SMFD RC Analog","Flap 3V",&dlgSmfdAnalog,"FLAPS 20 in Green");
ADD_TEST(408,408,4,"SMFD RC Analog","Flap 4V",&dlgSmfdAnalog,"Flaps 30 in Yellow");
ADD_TEST(409,409,4,"SMFD RC Analog","Generator Volt",&dlgSmfdAnalog,"28±1 V");
ADD_TEST(410,410,4,"SMFD RC Analog","Battery Volt",&dlgSmfdAnalog,"28±1 V");
ADD_TEST(411,411,4,"SMFD RC Analog","Current Load",&dlgSmfdAnalog,"200±10 A");

// -------- ANALOG2 --------
ADD_TEST(412,412,4,"SMFD RC Analog2","Hydraulic Main Pressure",&dlgSmfdAnalog2,"2930±20 psi");
ADD_TEST(413,413,4,"SMFD RC Analog2","Hydraulic Emergency Pressure",&dlgSmfdAnalog2,"3330±20 psi");
ADD_TEST(414,414,4,"SMFD RC Analog2","Emergency Brake Pressure",&dlgSmfdAnalog2,"1300±15 psi");
ADD_TEST(415,415,4,"SMFD RC Analog2","LH Brake Pressure",&dlgSmfdAnalog2,"1200±15 psi");
ADD_TEST(416,416,4,"SMFD RC Analog2","RH Brake Pressure",&dlgSmfdAnalog2,"1200±15 psi");
ADD_TEST(417,417,4,"SMFD RC Analog2","Engine Speed",&dlgSmfdAnalog2,"79±2 rpm");
ADD_TEST(418,418,4,"SMFD RC Analog2","Fuel LH",&dlgSmfdAnalog2,"168±5 lb");
ADD_TEST(419,419,4,"SMFD RC Analog2","Fuel RH",&dlgSmfdAnalog2,"168±5 lb");
ADD_TEST(420,420,4,"SMFD RC Analog2","Collector Tank Fuel",&dlgSmfdAnalog2,"183±5 lb");
...
switch(iCurr_Pointer)
{
    ...
    // ---------- ANALOG ----------
    case 9:  ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 10: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 11: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 12: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 13: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 14: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 15: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 16: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 17: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 18: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,FALSE,pUseFile); break;
    case 19: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog,TRUE ,pUseFile); break;

    // ---------- ANALOG2 ----------
    case 20: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 21: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 22: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 23: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 24: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 25: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 26: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 27: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,FALSE,pUseFile); break;
    case 28: ProcessTestRC(iCurrentTest,bDlgFlag,iResult,&dlgSmfdAnalog2,TRUE ,pUseFile); break;
