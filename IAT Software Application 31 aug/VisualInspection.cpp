...
BOOL VisualInspection::OnInitDialog()
{
	...
	//GetDlgItem(IDC_STATIC_KEYPAD)->SetWindowText("1.06  Keypad Marking: ALN,NAV,SET");	
...
/*
void VisualInspection::OnBnClickedCheckIsisDamage()
{
	...
	if (m_chkISISdamage)
	{
		GetDlgItem(IDC_CHECK_ISIS_DAMAGE)-> SetWindowText("Defect Found");
	}
	else
	{
		GetDlgItem(IDC_CHECK_ISIS_DAMAGE)-> SetWindowText("NO Defect");	
	}
...
void VisualInspection::OnBnClickedCheckIsisScrew()
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
	...
	if (m_chkISISScrews)
	{
		GetDlgItem(IDC_CHECK_ISIS_SCREW)-> SetWindowText("Defect Found");
	}
	else
	{
		GetDlgItem(IDC_CHECK_ISIS_SCREW)-> SetWindowText("No Defect");	
	}
...
void VisualInspection::OnBnClickedCheckIsisPins()
{
	// TODO: Add your control notification handler code here
		UpdateData(true);
	...
	if (m_chkISISPins)
	{
		GetDlgItem(IDC_CHECK_ISIS_PINS)-> SetWindowText("Defect Found");
	}
	else
	{
		GetDlgItem(IDC_CHECK_ISIS_PINS)-> SetWindowText("No Defect");	
	}
...
void VisualInspection::OnBnClickedCheckIsisScratches()
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
	...
	if (m_chkISISscratches)
	{
		GetDlgItem(IDC_CHECK_ISIS_SCRATCHES)-> SetWindowText("Defect Found");
	}
	else
	{
		GetDlgItem(IDC_CHECK_ISIS_SCRATCHES)-> SetWindowText("No Defect");	
	}
