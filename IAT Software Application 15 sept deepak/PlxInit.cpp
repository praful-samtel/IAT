...
#include "PlxInit.h"
	...
	extern S16               DeviceSelected;
	extern PLX_STATUS        rc;
	extern PLX_DEVICE_KEY    DeviceKey;
	extern PLX_DEVICE_OBJECT Device;
 ...
 *
 ********************************************************************/
S16 SelectDevice( PLX_DEVICE_KEY *pKey)
{
    S16            i;
    S16            j;
    S16            NumDevices;
    ...
    //do
    {
        ...
        //rc = PlxPci_DeviceFind(&DevKey, (U16)i);
