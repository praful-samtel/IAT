...
void CDlg_ISIS_PWR::OnBnClickedButtonIsispwr()
{
	// TODO: Add your control notification handler code here
	 ...
	 if(g_bSimulationMode)
		...
		CString message;
		CString LRU = "ISIS";
		FORMAT_CONNECT_LOAD_MSG(message, "ISIS", ISIS_FC_PWR_PIN_X, ISIS_FC_PWR_PIN_Y, ISIS_FC_PWR_CONNECTOR);
