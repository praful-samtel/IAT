...
void CDialog_ADC_Visual::OnBnClickedOk()
{
	...
	{
		g_strMsgStr.Format("ADC Part Number is not Correct, Do You want to Continue?");		
		msgdlg.DoModal();		
		if (!g_bContinueFlag)
		{
			return;
	...
	{
		g_strMsgStr.Format("physical damage present on ADC?, Do You want to Continue?");		
		msgdlg.DoModal();		
		if (!g_bContinueFlag)
		{
			return;
	...
	{
		g_strMsgStr.Format("ADC pressure holes is blocked, Do You want to Continue?");		
		msgdlg.DoModal();		
		if (!g_bContinueFlag)
		{
			return;
	...
	{
		g_strMsgStr.Format(" ADC has corrosion, Do You want to Continue?");		
		msgdlg.DoModal();		
		if (!g_bContinueFlag)
		{
			return;
	...
	{
		g_strMsgStr.Format("Foreign material present on ADC , Do You want to Continue?");		
		msgdlg.DoModal();		
		if (!g_bContinueFlag)
		{
			return;
