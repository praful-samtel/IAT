...
CLed::~CLed()
{
	//VERIFY(m_LedBitmap.DeleteObject()); Uncomment if added LED bitmap 
}
...
///////////////////////////////////////////////////////////////////////////////
/*******************************************************************************
*  Function Name    = DrawLed							                       *
*  Class			= CLed													   *
*  Return Type      = void								                       *
*  Parameters       = CDC *pDC,int nLEDColor, int nMode, int nShape			   *					                                   
*  Description      = This method will draw the LED to the specified DC.	   *
********************************************************************************/
void CLed::DrawLed(CDC *pDC,int nLEDColor, int nMode, int nShape)
{
...
*  Class			= CLed													   *
*  Return Type      = void								                       *
*  Parameters       = int nLedColor, int nMode, int nShape					   *
*  Visibility	    = Public												   *						                                   
*  Description      = This method will draw and set led parameters.			   *
********************************************************************************/
void CLed::SetLed(int nLedColor, int nMode, int nShape)
...
*  Visibility	    = Public												   *						                                   
*  Description      = This method will turn the led on for dwTimeout		   *
*  miliseconds and then turn it off.										   *
********************************************************************************/
void CLed::Ping(DWORD dwTimeout)
{
	// Return if pinging
...
*  Visibility	    = Public												   *						                                   
*  Description      = This function is used as timer of LED.				   *
********************************************************************************/
void CLed::OnTimer(UINT_PTR nIDEvent) 
{
