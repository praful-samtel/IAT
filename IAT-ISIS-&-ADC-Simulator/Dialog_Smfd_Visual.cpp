...
void CDialog_Smfd_Visual::OnBnClickedCheckSmfdDamage()
{
   ...
   if (m_ctlChk_smfd_damage)
	{
		GetDlgItem(IDC_CHECK_SMFD_DAMAGE)->SetWindowText("Ok");
	}
	else
	{
		GetDlgItem(IDC_CHECK_SMFD_DAMAGE)->SetWindowText("Not Ok");
	}
    UpdateData(FALSE);
}
...
{ 
    ...
    {
        g_strMsgStr.Format("SMFD Damage is not ok, Do You want to Continue?");
        msgdlg.DoModal();
...
void CDialog_Smfd_Visual::OnBnClickedCheckSmfdScratches()
{
   ...
   if (m_chkSmfdScratches)
	{
		GetDlgItem(IDC_CHECK_SMFD_SCRATCHES)->SetWindowText("Ok");
	}
	else
	{
		GetDlgItem(IDC_CHECK_SMFD_SCRATCHES)->SetWindowText("Not Ok");
	}
    UpdateData(FALSE);
}
...
void CDialog_Smfd_Visual::OnBnClickedCheckSmfdScrew()
{
   ...
   if (m_chkSmfdScrews)
	{
		GetDlgItem(IDC_CHECK_SMFD_SCREW)->SetWindowText("Ok");
	}
	else
	{
		GetDlgItem(IDC_CHECK_SMFD_SCREW)->SetWindowText("Not Ok");
	}
    UpdateData(FALSE);
}
...
void CDialog_Smfd_Visual::OnBnClickedCheckSmfdPins()
{
   ...
   if (m_chkSmfdPins)
	{
		GetDlgItem(IDC_CHECK_SMFD_PINS)->SetWindowText("Ok");
	}
	else
	{
		GetDlgItem(IDC_CHECK_SMFD_PINS)->SetWindowText("Not Ok");
	}
    UpdateData(FALSE);
}
