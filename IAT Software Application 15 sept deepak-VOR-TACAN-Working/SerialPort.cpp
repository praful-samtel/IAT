...
BOOL CSerialPort::WriteByte1(BYTE *bybyte, unsigned short int size)
{
	...
	// Use this instance's handle.  haComm is a global that is overwritten
	// whenever another COM port is configured, which sends FC/RC packets to
	// the wrong physical port during a loopback simulation.
